...
class HaikyuuCardGame {
    ...
    advancePhase() {
        ...
        if (this.state.phase === GamePhase.SERVE) {
            ...
            // After block, blocker becomes receiver (flow: A B A B)
            nextPhase = GamePhase.RECEIVE;
            nextPlayer = this.state.currentPlayer;  // Blocker becomes receiver
            this.state.attackingPlayer = this.getOpponent(this.state.currentPlayer);
        }
